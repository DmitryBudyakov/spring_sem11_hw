package com.example.spring_sem11_hw.controller;

import com.example.spring_sem11_hw.model.Note;
import com.example.spring_sem11_hw.repository.NoteRepo;
...
public class NoteController {
    ...
    private final Counter requestedCount = Metrics.counter("request_count");
    ...
    public ResponseEntity<List<Note>> getAll() {
        //подсчет общего количества обращений
        requestedCount.increment();
